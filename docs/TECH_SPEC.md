...
| `models.py` | Source reflection, model code generation | `ModelGenerator` |
...
|------|--------|--------|------------|
| 1 | `models.py` | Reflect source, generate `models.py` | Retry: `smt generate` |
...
| 4 | `migration.py` + `database.py` | Generate DDL, apply, verify tables | Retry: `smt apply` |
